...
export const FULL_REPORT_NOTE = `
  - Don't include characters "*", "[", "]" in response!!!.
  - INCLUDE all **9** sections. DON'T MISS any section.
  - The content of each section should formatted as a **list** with **<li>** tag.
  - The content of each section should start on a **new line**, not the title line.
  - DON'T MAKE **last section** && **first section** as list. First section MUST formatted as a example format.
  - Each section MUST include a **title**.
  - Do not INCLUDE any descriptive sentences before the section.
  - Titles of each sections MUST be **14px**.
  - Do not use any **prefixes** before titles. For example: "A.", "1.". Padding top should be **14px** padding bottom should be **4px**.
  - Titles of each sections MUST **font-bold**.
  - <ul> should be left padding **14px** for indentation.`;
