...
export const FULL_REPORT_NOTE = `
  ...
  - Make each section a **list**. DON'T MAKE only **last section** as list
  ...
  - Do not use any **prefixes** before titles. For example: "A.", "1.". 
  - Title of each sections' padding top should be 12px padding bottom should be 8px.
