...
export const FULL_REPORT_NOTE = `
  - Sections
    ...
    9. Closing
  - Titles of each sections should be 14px & font-bold. Don't use prefix numbers, just letters. Padding top should be 12px padding bottom should be 8px.
  - Each section title MUST font-bold.
