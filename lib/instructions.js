export const instructions = {
  ...
  get_segements_report: `
      ...
      - Make each section a list. Do not include any descriptive sentences about the section in the section, just make it a list. Don't make only last section as list.
      - Each section MUST include a title.
      - The content of each section should start on a new line, not the title line.`,
  get_fan_segments:
